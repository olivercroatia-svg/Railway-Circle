...
const SERVICES_DATA = [
  {
    key: 'rail',
    image: `${import.meta.env.BASE_URL}assets/vectron-rail-blue.png`,
    icon: (
  ...
  {
    key: 'dangerous',
    image: `${import.meta.env.BASE_URL}assets/tank-wagons.png`,
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    key: 'special',
    image: `${import.meta.env.BASE_URL}assets/special-cargo.png`,
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    key: 'customs',
    image: `${import.meta.env.BASE_URL}assets/customs-office.png`,
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
